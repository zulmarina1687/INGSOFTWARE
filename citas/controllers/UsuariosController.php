...
class UsuariosController{
    ...
    public function login(){ 
        ...
        if(isset($_POST["submit"])){
           ...
           if($_POST['tipo_id']==1){
                  ...
                  PacientesController::login($datosLogin);
               
           }else{
            ////////           
                   // print_r(" siga todo el usuario normal"); die;
     ...
     public static function lista_medicos(){
         $respuesta = Usuario::lista_medicos();
         return $respuesta;
    ...
    public static function combo_usuarios_medicos(){
         $respuesta = Usuario::combo_usuarios_medicos();
         return $respuesta;
